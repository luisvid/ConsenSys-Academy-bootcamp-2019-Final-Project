      ...
      return this.props.paused
        ...
        : (
            <div>
              ...
              <p>Pauses contract. Stops all users from all actions except for store owners to withdraw funds</p>
  ...
  render() {
    return (
      <div>
        ...
        <div>
          <Button basic color='green' onClick={this.addStoreOwner}>Add Store Owner</Button>
          <Button basic color='red' onClick={this.removeStoreOwner}>Remove Store Owner</Button>
        </div>
        <div>
          <Link to='/store-owners'>View Store Owners</Link>
        </div>
        <Divider section />
